...
and one is the data projected on canonical principal components (having the suffix '-pca'). The projection matrix is
...
The canonical principal components are located in 'data/principal_components.npz'. These are the principal components
which will be used for all projections, and are generated from a large sample of trajectories. We use a fixed PCA base
to make learning on the dimensionality reduced space viable over different trajectories and different Lorenz systems.
